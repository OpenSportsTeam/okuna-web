export default {
    ...
    "pages": {
        "auth": {
            "title": "Dashboard your activities",
            "usps": {
                "friends": "Stay fit, connect with others, compete against the world and get benefits and support from the team.",
                "privacy": "OpenSportsTeam - ALL nations, ALL sports, ONE team",
    ...
    "forms": {
        "report_object": {
            ...
            "if_reporting_post_or_comment": "If you are reporting a post or comment, the report will be sent to the OpenSportsTeam staff and the community moderators if applicable and the post will be hidden from your feed.",
            "if_reporting_account_or_community": "If you are reporting an account or community, it will be sent to the OpenSportsTeam staff.",
    ...
    "global": {
        ...
        "snippets": {
            ...
            "legal_confirmation_description": "By registering in OpenSportsTeam, I certify that I'm older than 16 years old and have read the Community Guidelines, Privacy Policy and Terms of Use and agree to all of the items included.",
            ...
            "documents_contain_important_information": "They contain important information about your experience in OpenSportsTeam and you must agree to them.",
            ...
            "okuna_web_is_wip": "OpenSportsTeam for the web is a work-in-progress.",
            "get_the_mobile_app": "Get the OpenSportsTeam mobile app to create posts, circles, lists, moderate your communities reports and more.",
            "glad_you_made_it": "We're glad you made it!",
            "welcome_to_okuna": "Welcome to OpenSportsTeam for the web.",
            ...
            "welcome_to_okuna_get_the_app": "If you want to experience the whole of OpenSportsTeam right now, get the app!",
            "welcome_to_okuna_thanks": "Thanks for being part of OpenSportsTeam! We hope you have a fun, friendly and joyful experience.",
            "welcome_to_okuna_signature": "- ❤️ OpenSportsTeam Team",
